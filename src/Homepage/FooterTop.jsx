...
import { MdGroups, MdLocalShipping } from 'react-icons/Md'
    ...
    <div className='footer'>
      <div className='text_section'>
        <div className='about_company'>
          <MdGroups className='icons_footer' size="46"/>
        ...
        <div className='about_products'>
          <BsBox className='icons_footer' size="46"/>
        ...
        <div className='about_shipping'>
          <MdLocalShipping className='icons_footer' size="46"/>
